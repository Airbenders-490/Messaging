...
type RoomRepository interface {
	...
	AddParticipantToRoomAndAddRoomForParticipant(roomID string, studentID string) error
	RemoveParticipantFromRoomAndRemoveRoomForParticipant(roomID string, studentID string) error
}
